...
class ImportSampleAccountsUseCase @Inject constructor(
    private val accountRepository: AccountRepository,
    private val userRepository: UserRepository,
    @ApplicationContext private val context: Context
) {
    suspend operator fun invoke(): ResultState<Unit> = importFromStream(context.assets.open("sample_accounts.csv"))

    private suspend fun importFromStream(inputStream: java.io.InputStream): ResultState<Unit> = try {
        coroutineScope {
